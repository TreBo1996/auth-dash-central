                  ...
                  <div className="space-y-2">
                    ...
                    {atsFeedback.keyword_analysis.matched_keywords.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {atsFeedback.keyword_analysis.matched_keywords.slice(0, 5).map((keyword, index) => (
                    ...
                    {atsFeedback.keyword_analysis.missing_keywords.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {atsFeedback.keyword_analysis.missing_keywords.slice(0, 5).map((keyword, index) => (
                            <Badge key={index} variant="outline" className="text-xs px-1 py-0 border-red-200">
                              {keyword}
                            </Badge>
                          ))}
                        </div>
                ...
                {atsFeedback.recommendations && atsFeedback.recommendations.length > 0 && (
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1">
                      {atsFeedback.recommendations.slice(0, 3).map((rec, index) => (
