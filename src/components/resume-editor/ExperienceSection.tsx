...
export const ExperienceSection: React.FC<ExperienceSectionProps> = ({
  ...
  const openAISuggestions = (experienceId: string) => {
    const experience = experiences.find(exp => exp.id === experienceId);
  ...
  const handleSelectBullets = (bullets: string[]) => {
    const experience = experiences.find(exp => exp.id === modalState.experienceId);
    if (experience) {
      let newDescription = experience.description;
      ...
      // Add each selected bullet point
      bullets.forEach(bullet => {
        newDescription += bullet + '\n';
      });
      
      updateExperience(modalState.experienceId, 'description', newDescription);
    }
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    {jobDescriptionId && experience.company && experience.role && (
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => openAISuggestions(experience.id)}
