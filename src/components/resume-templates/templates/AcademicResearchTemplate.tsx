  ...
  return <div className="w-full max-w-[8.5in] mx-auto bg-white p-12 text-sm leading-normal" style={{
    ...
    minHeight: '11in'
      ...
      <header className="text-center mb-10 pb-6 border-b border-gray-300">
        ...
        {resumeData.experience.length > 0 && <h2 className="text-base font-medium italic" style={{
      ...
      {resumeData.education.length > 0 && <section className="mb-8">
        ...
        borderColor: config.colors.border
          ...
          <div className="space-y-4">
            {resumeData.education.map((edu, index) => <div key={index} className="flex justify-between">
            ...
            {resumeData.experience.map((exp, index) => <div key={index} className="job-entry">
              ...
              color: config.colors.textSecondary
                ...
                <ul className="space-y-1 list-disc list-inside ml-4">
                  {exp.bullets.map((bullet, bulletIndex) => <li key={bulletIndex} className="bullet-point" style={{
              color: config.colors.text
            }}>
                      {bullet}
                    </li>)}
      ...
      {resumeData.certifications && resumeData.certifications.length > 0 && <section className="mb-8">
          <h2 className="text-base font-bold mb-4 text-center border-b pb-2" style={{
        fontFamily: config.fonts.heading,
        color: config.colors.primary,
        borderColor: config.colors.border
          ...
          <div className="space-y-3">
            {resumeData.certifications.map((cert, index) => <div key={index} className="flex justify-between">
                <div>
                  <h3 className="font-bold" style={{
              color: config.colors.primary
            }}>
